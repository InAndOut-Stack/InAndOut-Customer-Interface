...
import { Box, Typography, Stack, Pagination, Card, CardContent, CardMedia, CardActionArea, CircularProgress, Grid } from '@mui/material';
    ...
    return (
        <Stack sx={{ 
            ...
            {isLoading ? (
                ...
                <>
                    <Grid container spacing={4} sx={{ maxWidth: '1200px', margin: '0 auto', flexGrow: 1 }}>
                                ...
                                >
                                    <CardActionArea>
                                        <CardMedia
                                            component="img"
                                            height="200"
                                            image={store.imageUrl || 'https://via.placeholder.com/400x200?text=No+Image'}
                                            alt={store.name}
                                        />
                                        <CardContent sx={{ backgroundColor: 'white', minHeight: '150px' }}>
                                            <Typography gutterBottom variant="h5" sx={{ fontFamily: '"Creato", sans-serif', fontWeight: 600, color: colors.purpleColor }}>
                                                {store.name}
                                            </Typography>
                                            <Typography variant="body2" color="text.secondary" sx={{ fontFamily: '"Creato", sans-serif' }}>
                                                {store.description}
                                            </Typography>
                                        </CardContent>
                                    </CardActionArea>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', marginTop: '60px', paddingBottom: '40px' }}>
                        <Pagination 
